...
async def on_message(message):
    ...
    if "https://twitter.com" in message.content:
        await send_webhook_message(message.guild, message.channel, message.author, message.content.replace("https://twitter.com/","https://fixupx.com/"))
        await message.delete()
        await log(None, f"Replaced {message.content} with FixupX Link", None, None, message.channel)
    if "https://x.com/" in message.content:
        await send_webhook_message(message.guild, message.channel, message.author, message.content.replace("https://x.com/","https://fixupx.com/"))
        await message.delete()
        await log(None, f"Replaced {message.content} with FixupX Link", None, None, message.channel)
